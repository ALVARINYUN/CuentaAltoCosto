(function () {
  ...
  const VARIABLES_VALIDABLES = [
    ...
    'V67', 'V68', 'V69', 'V70', 'V71', 'V72', 'V73', 'V74', 'V75', 'V76', 'V77', 'V78', 'V79', 'V80', 'V81', 'V82', 'V83', 'V84', 'V85', 'V86'
  ];
  ...
  function normalizarEncabezado(valor) {
    ...
    if (match) {
      ...
      if (Number.isInteger(numero) && numero >= 1 && numero <= 86) return `V${numero}`;
    }
  ...
  function analizarFilaEncabezados(fila) {
    ...
    const bonusVariables = [
      ...
      'V54', 'V55', 'V56', 'V57', 'V58', 'V59', 'V60',
      'V61', 'V62', 'V63', 'V64', 'V65',
      'V66', 'V66_1', 'V66_2', 'V66_3', 'V66_4', 'V66_5', 'V66_6', 'V66_7', 'V66_8', 'V66_9', 'V67', 'V68', 'V69', 'V70', 'V71', 'V72', 'V73', 'V74', 'V75', 'V76', 'V77', 'V78', 'V79', 'V80', 'V81', 'V82', 'V83', 'V84', 'V85', 'V86', 'V82', 'V81'
    ];
