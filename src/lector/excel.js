(function () {
  ...
  // Variables válidas acumuladas hasta Sprint 3B.
  // V1-V44: incluye V41-V44 para que el lector no las descarte.
  const VARIABLES_VALIDABLES = Array.from({ length: 44 }, (_, i) => `V${i + 1}`);
