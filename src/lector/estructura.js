(function () {
  ...
  const VERSION = 'sprint-3o-v134-estructura-01';
  ...
  const VARIABLES_SPRINT_3N = ['V111', 'V112', 'V113', 'V114', 'V114_1', 'V114_2', 'V114_3', 'V114_4', 'V114_5', 'V114_6', 'V115', 'V116', 'V117', 'V118', 'V119', 'V120', 'V121', 'V122', 'V123', 'V124', 'V125'];
  const VARIABLES_SPRINT_3O = ['V126', 'V127', 'V128', 'V129', 'V130', 'V131', 'V132', 'V133', 'V134'];
  ...
  const VARIABLES_HASTA_3N_V125 = [...VARIABLES_HASTA_3N_V124, 'V125'];
  const VARIABLES_HASTA_3N = VARIABLES_HASTA_3N_V125;
  const VARIABLES_HASTA_3O_V126 = [...VARIABLES_HASTA_3N_V125, 'V126'];
  const VARIABLES_HASTA_3O_V127 = [...VARIABLES_HASTA_3O_V126, 'V127'];
  const VARIABLES_HASTA_3O_V128 = [...VARIABLES_HASTA_3O_V127, 'V128'];
  const VARIABLES_HASTA_3O_V129 = [...VARIABLES_HASTA_3O_V128, 'V129'];
  const VARIABLES_HASTA_3O_V130 = [...VARIABLES_HASTA_3O_V129, 'V130'];
  const VARIABLES_HASTA_3O_V131 = [...VARIABLES_HASTA_3O_V130, 'V131'];
  const VARIABLES_HASTA_3O_V132 = [...VARIABLES_HASTA_3O_V131, 'V132'];
  const VARIABLES_HASTA_3O_V133 = [...VARIABLES_HASTA_3O_V132, 'V133'];
  const VARIABLES_HASTA_3O_V134 = [...VARIABLES_HASTA_3O_V133, 'V134'];
  const VARIABLES_HASTA_3O = VARIABLES_HASTA_3O_V134;
  const VARIABLES_ESPERADAS = VARIABLES_HASTA_3O_V134;
  ...
  Object.assign(MAPA_ENCABEZADOS, {
    ...
    v125tipodetratamientoqueestrecib: 'V125',
    v125tipotratamientofechacorte: 'V125',
    v125tratamientofechacorte: 'V125',
    v126resultadofinaldelmanejooncol: 'V126',
    v126resultadofinalmanejooncologico: 'V126',
    v126resultadofinaldelmanejooncologico: 'V126',
    v126resultadofinal: 'V126',
    v127estadovitalalfinalizaresteco: 'V127',
    v127estadovitalalfinalizaresteperiodo: 'V127',
    v127estadovital: 'V127',
    v127vivoofallecido: 'V127',
    v128novedadadministrativarespect: 'V128',
    v128novedadadministrativarespecto: 'V128',
    v128novedadadministrativarespectoalreporteanterior: 'V128',
    v128novedadadministrativa: 'V128',
    v128novedadadmin: 'V128',
    v129novedadclnicaalafechadecorte: 'V129',
    v129novedadclinicaalafechadecorte: 'V129',
    v129novedadclnica: 'V129',
    v129novedadclinica: 'V129',
    v129novedadclinicafechacorte: 'V129',
    v130fechadedesafiliacindelaeps: 'V130',
    v130fechadedesafiliaciondelaeps: 'V130',
    v130fechadedesafiliacindelaeapb: 'V130',
    v130fechadedesafiliaciondelaeapb: 'V130',
    v130fechadesafiliacioneps: 'V130',
    v130fechadesafiliacioneapb: 'V130',
    v130fechadedesafiliacion: 'V130',
    v130fechadesafiliacion: 'V130',
    v131fechademuerte: 'V131',
    v131fechadefallecimiento: 'V131',
    v131fechamuerte: 'V131',
    v131muerte: 'V131',
    v132causademuerte: 'V132',
    v132causafallecimiento: 'V132',
    v132causadelamuerte: 'V132',
    v132causadefallecimiento: 'V132',
    var133cdigonicodeidentificacinbd: 'V133',
    v133cdigonicodeidentificacinbd: 'V133',
    v133codigounicodeidentificacionbd: 'V133',
    v133codigounicoidentificacionbd: 'V133',
    v133bduabdexpvs: 'V133',
    v133codigobduabdexpvs: 'V133',
    var134fechadecorte: 'V134',
    v134fechadecorte: 'V134',
    v134fechacorte: 'V134',
    v134corte: 'V134',
  ...
  const MODOS = [
    ['V134', 'ACUMULATIVO_V1_V134', VARIABLES_HASTA_3O_V134],
    ['V133', 'ACUMULATIVO_V1_V133', VARIABLES_HASTA_3O_V133],
    ['V132', 'ACUMULATIVO_V1_V132', VARIABLES_HASTA_3O_V132],
    ['V131', 'ACUMULATIVO_V1_V131', VARIABLES_HASTA_3O_V131],
    ['V130', 'ACUMULATIVO_V1_V130', VARIABLES_HASTA_3O_V130],
    ['V129', 'ACUMULATIVO_V1_V129', VARIABLES_HASTA_3O_V129],
    ['V128', 'ACUMULATIVO_V1_V128', VARIABLES_HASTA_3O_V128],
    ['V127', 'ACUMULATIVO_V1_V127', VARIABLES_HASTA_3O_V127],
    ['V126', 'ACUMULATIVO_V1_V126', VARIABLES_HASTA_3O_V126],
    ['V125', 'ACUMULATIVO_V1_V125', VARIABLES_HASTA_3N_V125],
  ...
  window.CACEstructura = {
    ...
    VARIABLES_SPRINT_3A, VARIABLES_SPRINT_3B, VARIABLES_SPRINT_3C, VARIABLES_SPRINT_3D, VARIABLES_SPRINT_3E, VARIABLES_SPRINT_3F, VARIABLES_SPRINT_3G, VARIABLES_SPRINT_3H, VARIABLES_SPRINT_3H_MODULO15, VARIABLES_SPRINT_3I, VARIABLES_SPRINT_3J, VARIABLES_SPRINT_3K, VARIABLES_SPRINT_3L, VARIABLES_SPRINT_3M, VARIABLES_SPRINT_3N, VARIABLES_SPRINT_3O,
    ...
    esEncabezadoV125: crearFuncionEncabezado('V125'),
    esEncabezadoV126: crearFuncionEncabezado('V126'),
    esEncabezadoV127: crearFuncionEncabezado('V127'),
    esEncabezadoV128: crearFuncionEncabezado('V128'),
    esEncabezadoV129: crearFuncionEncabezado('V129'),
    esEncabezadoV130: crearFuncionEncabezado('V130'),
    esEncabezadoV131: crearFuncionEncabezado('V131'),
    esEncabezadoV132: crearFuncionEncabezado('V132'),
    esEncabezadoV133: crearFuncionEncabezado('V133'),
    esEncabezadoV134: crearFuncionEncabezado('V134')
  };
})();
