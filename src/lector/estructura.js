(function () {
  ...
  const VERSION = 'sprint-3n-v111-estructura-01';
  ...
  const VARIABLES_SPRINT_3N = ['V111'];
  ...
  const VARIABLES_HASTA_3N = VARIABLES_HASTA_3N_V111;
  const VARIABLES_ESPERADAS = VARIABLES_HASTA_3N_V111;
