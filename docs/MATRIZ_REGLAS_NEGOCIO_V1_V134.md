...
**Alcance documentado en esta versión:** V1-V16  
...
Documentar las reglas de negocio reales implementadas en el Validador CAC — Cáncer.

Esta matriz debe registrar cada variable de forma individual, con:
...
| Matriz de reglas consolidada en este archivo | V1-V16 |
| Siguiente bloque a consolidar | V17-V24 |
| Archivo fuente usado para esta entrega | `src/validaciones/reglas/modulo1.js` |
